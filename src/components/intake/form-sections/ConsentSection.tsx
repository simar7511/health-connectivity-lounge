...
export const ConsentSection = ({ language, checked, onCheckedChange }: ConsentSectionProps) => {
  return (
    <div className="space-y-4 bg-white p-6 rounded-xl shadow-md border border-gray-200 transition-all hover:shadow-lg">
      <h3 className="text-lg font-semibold text-primary flex items-center gap-3">
        <span className="bg-gradient-to-r from-primary to-primary/80 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm shadow-md">4</span>
        {language === "en" ? "Consent Statement" : "Declaración de Consentimiento"}
      </h3>

      <div className="flex items-center space-x-3 p-4 bg-purple-50 rounded-lg border border-purple-100 transition-all hover:bg-purple-100/50">
        <Checkbox
